...
test_data = unpickle(os.path.join(DATA_PATH, 'test_batch'))[b'data'].reshape(-1,3,32*32).transpose(0,2,1) / 255.0
...
datas = datas.reshape(-1,3,32*32).transpose(0,2,1) / 255.0
